# GROEPEN & VERHUUR — complete paginatekst (v2)

*Definitieve werkversie voor de nieuwe website van Café Costa. Alleen de foto's ontbreken nog.*
...
**Tekst:**
Zaterdagavond, Stratumseind, en jij hoeft nergens voor te vechten. Geen rij, geen zoeken, geen statafel delen met vreemden. Jullie tafel staat klaar, op naam — en de avond is al geregeld voordat je binnenstapt.

**Wat krijg je:**
- Gereserveerde VIP-tafel voor 6 tot 12 personen, de hele avond van jullie
- € 150 drankentegoed, vooraf betaald — makkelijk vooraf te splitten met je vrienden
- Welkomstshotje voor de hele groep bij binnenkomst
- Alles geregeld, tot aan gratis toiletgebruik voor de hele groep — portemonnee kan de hele avond in je zak

**Prijs:** € 150 per tafel, volledig te besteden aan de bar

**Knop:** Vraag je tafel aan
...
**Tekst:**
Bedrijfsfeest, jubileum of een feest dat te groot is voor een zaaltje? Huur heel Café Costa af: de beste feest-DJ's van het land, confettikanonnen en een team van 50 man dat één opdracht heeft — jullie avond onvergetelijk maken. Capaciteit, invulling en prijs? Dat is maatwerk, en maatwerk begint met een gesprek.

**Knop:** Plan een gesprek

---

## AANVRAAGFORMULIER (één formulier voor alle drie de producten)
...
5. Gewenste datum (+ eventueel reservedatum)
6. Aantal personen
7. Gelegenheid: verjaardag / vrijgezellenfeest / bedrijfsfeest / anders
8. Opmerkingen (optioneel)

**Bevestigingstekst na verzenden:**
"Je aanvraag is binnen! Je hoort binnen 24 uur van ons — meestal veel sneller. Houd je mail (en spamfolder) in de gaten."

*(Interne wet, niet op de site: alle aanvragen landen bij mitch@cafecosta.nl. Reactie binnen 24 uur is het minimum, binnen het uur is de norm tijdens kantooruren. Het formulier is het enige kanaal — een stille inbox is een lekkende kassa. En: haal mitch@ van de openbare ticketpagina af; het adres hoort achter het formulier, niet op straat.)*

---

## VEELGESTELDE VRAGEN (onderaan de pagina)

**Kan de besloten ruimte ook doordeweeks?**
Altijd bespreekbaar. Zet je gewenste datum in de aanvraag en we kijken wat er kan.

**Mogen we eigen muziek draaien?**
Ja — er staat een DJ-booth klaar. Neem je eigen DJ mee of sluit je eigen playlist aan.

**Tot hoe laat kan het feest doorgaan?**
Op vrijdag en zaterdag tot 04:00, op overige dagen tot 02:00.
...
1. 3–5 foto's: volle VIP-tafel met flessen, de besloten ruimte leeg én vol, groepsfoto vrijgezellenfeest
2. Antwoord op de eten/hapjes-vraag in de FAQ
3. Betaalverzoek-methode kiezen (Tikkie zakelijk, Mollie-betaallink of factuur) en het proces bij mitch@ inregelen
